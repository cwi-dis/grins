...
try:
	...
	Res.OpenResFile(':macg2lite.rsrc')
...
# macfreeze: exclude LabelChannel
# macfreeze: exclude MidiChannel
# macfreeze: exclude PythonChannel
# macfreeze: exclude WordChannel
# macfreeze: exclude HtmlChannel
# macfreeze: exclude PseudoHtmlChannel
#
