...
set PYTHONPATH=%PYTHONPATH%;%GRINS_HOME%\%FREEZE_WHAT%\qtpro
set PYTHONPATH=%PYTHONPATH%;%GRINS_HOME%\%FREEZE_WHAT%\qtpro\win32
...
echo -x RealPixChannel >> FreezeOpts
echo -x RealTextChannel >> FreezeOpts
echo -x RealVideoChannel >> FreezeOpts
