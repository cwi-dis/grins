	...
	def create_window(self, pchan, pgeom):
		...
		if pchan:
			...
			if self.want_default_colormap:
				self.window = pchan.window.newcmwindow(self._window_type, pgeom,
						transparent = transparent)
			else:
				self.window = pchan.window.newwindow(self._window_type, pgeom,
						transparent = transparent)
			...
			if self.want_default_colormap:
				self.window = windowinterface.newcmwindow(x, y,
						width, height, self._name, self._visible, self._window_type)
			else:
