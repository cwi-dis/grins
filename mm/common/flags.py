...
FLAG_PRO = FLAG_G2_PRO | FLAG_QT_PRO | FLAG_SMIL_1_0 | FLAG_BOSTON | FLAG_SMIL21 | FLAG_SMIL30
FLAG_ALL = FLAG_G2 | FLAG_QT | FLAG_CMIF | FLAG_SMIL_1_0 | FLAG_BOSTON | FLAG_SMIL21 | FLAG_SMIL30
    ...
    if _curflags is None:
        ...
        if hasattr(features, 'feature_set'):
            ...
            if features.EXPORT_QT in features.feature_set:
                flags = flags | FLAG_QT
            if features.EXPORT_SMIL20 in features.feature_set:
                flags = flags | FLAG_BOSTON
            if features.EXPORT_SMIL21 in features.feature_set:
                flags = flags | FLAG_SMIL21
            if features.EXPORT_SMIL30 in features.feature_set:
                flags = flags | FLAG_SMIL30
            ...
            flags = flags | FLAG_BOSTON
        elif features.compatibility == features.SMIL21:
            flags = flags | FLAG_SMIL21
        elif features.compatibility == features.SMIL30:
            flags = flags | FLAG_SMIL30
