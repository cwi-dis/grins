...
class TopLevel(TopLevelDialog, ViewDialog):
    ...
    def create_commandlist(self):
        ...
        if not features.lightweight:
            ...
            if features.PARAMGROUP_VIEW in feature_set:
                self.__ugroup.extend([
                    PARAMGROUPVIEW(callback = (self.view_callback, (11, ))),
                    HIDE_PARAMGROUPVIEW(callback = (self.hide_view_callback, (11, ))),
                    ])
...
##                     ])
    ...
    def update_undocommandlist(self):
        ...
        if not self.context.disableviews:
            ...
            if self.context.smilversion >= 20:
...
##         for i in viewinfo: print 'VIEWINFO', i
    ...
    def makeviews(self):
        ...
        if features.PARAMGROUP_VIEW in features.feature_set:
            import ParamgroupView
            self.paramgroupview = ParamgroupView.ParamgroupView(self)
    ...
    def save_to_file(self, filename, exporting = 0):
        ...
        if exporting:
            ...
            if exporttype == 'REAL':
                ...
                addattrs = 1
                pssExt = 'pss5' # other possibility: 'pss5'
