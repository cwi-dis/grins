...
class ParamgroupViewDialog(windowinterface.MACDialog):
    def __init__(self):
        ...
        windowinterface.MACDialog.__init__(self, "Paramgroup view",
					   ID_DIALOG_UGROUP_BROWSER,
					   ITEMLIST_B_ALL)
...
##             self.__window.hide()
    ...
    def do_itemhit(self, item, event):
        if item == ITEM_B_BROWSER:
            ...
            print 'Unknown ParamgroupViewDialog item', item, 'event', event
        return 1
