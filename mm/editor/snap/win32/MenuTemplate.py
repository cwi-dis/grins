...
MENUBAR=(
	('&File', (
		...
		(FLAG_G2|FLAG_SNAP, ENTRY, 'Publish for &G2...', None, EXPORT_G2),
		(FLAG_G2|FLAG_SNAP, ENTRY, 'Pu&blish for G2 and upload...', None, UPLOAD_G2),
		...
		(FLAG_SMIL_1_0, ENTRY, 'Pu&blish for SMIL 2.0 and upload...', None, UPLOAD_SMIL),
...
##		(FLAG_PRO, ENTRY, '&Timeline view\tF7', '4', CHANNELVIEW),
		(FLAG_ALL, ENTRY, '&Layout view', None, LAYOUTVIEW2),
