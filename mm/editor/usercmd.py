...
class PARAMGROUPVIEW(_CommandBase):
    help = 'Show Paramgroup view'
...
class HIDE_PARAMGROUPVIEW(_CommandBase): pass
...
class PARAMGROUP(_DynamicCascade):
    help = 'Selection of available paramgroups'
