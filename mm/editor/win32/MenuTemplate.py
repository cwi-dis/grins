...
MENUBAR=(
	('&File', (
		...
		(FLAG_ALL, SEP,),
		(FLAG_QT_PRO, ENTRY, 'Publish for &QuickTime...', None, EXPORT_QT),
		...
		(FLAG_ALL|DBG, SEP,),
		(FLAG_ALL|DBG, CASCADE, 'D&ebug', (
			(FLAG_ALL, ENTRY, 'Dump &scheduler data', None, SCHEDDUMP),
			(FLAG_ALL, TOGGLE, 'Enable call &tracing', None, TRACE),
			(FLAG_ALL, ENTRY, 'Enter &debugger', None, DEBUG),
			(FLAG_ALL, ENTRY, '&Abort', None, CRASH),
			(FLAG_ALL, TOGGLE, 'Show &log/debug window', None, CONSOLE),
			)),
		(FLAG_ALL, SEP,),
...
MAIN_FRAME_POPUP = (
		...
		(FLAG_ALL|DBG, SEP,),
		(FLAG_ALL|DBG, CASCADE, 'D&ebug', (
			(FLAG_ALL|DBG, ENTRY, 'Dump scheduler data', None, SCHEDDUMP),
			(FLAG_ALL|DBG, TOGGLE, 'Enable call tracing', None, TRACE),
			(FLAG_ALL|DBG, ENTRY, 'Enter debugger', None, DEBUG),
			(FLAG_ALL|DBG, ENTRY, 'Abort', None, CRASH),
			(FLAG_ALL|DBG, TOGGLE, 'Show log/debug window', None, CONSOLE),
			)),
		(FLAG_ALL, SEP,),
		(FLAG_ALL, ENTRY, '&Close', None, CLOSE),
		(FLAG_ALL, ENTRY, 'E&xit', None, EXIT),
