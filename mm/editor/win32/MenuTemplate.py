...
MENUBAR=(
        ('&File', (
                ...
                (FLAG_ALL, CASCADE, 'Publish', (
                        ...
                        (FLAG_ALL, ENTRY, 'Publish for &RealOne...', None, EXPORT_G2),
                        (FLAG_ALL, ENTRY, 'Publish for RealOne and &upload...', None, UPLOAD_G2),
                        ...
                        (FLAG_ALL, ENTRY, 'Publish for &IE-6 HTML+TIME...', None, EXPORT_HTML_TIME),
                        (FLAG_ALL, SEP,),
                        (FLAG_ALL, ENTRY, 'Publish for RealPlayer 8...', None, EXPORT_SMIL1),
                        (FLAG_ALL, SEP,),
                        (FLAG_ALL, ENTRY, '&Publish for GRiNS SMIL 2.0 Player...', None, EXPORT_SMIL),
                        (0, ENTRY, 'Publish for &SMIL 2.0 and upload...', None, UPLOAD_SMIL),
                        (FLAG_ALL, ENTRY, '&Publish for GRiNS/PocketPC Player...', None, EXPORT_WINCE),
                        (FLAG_ALL, SEP,),
##             (FLAG_ALL, ENTRY, 'P&rune and publish for 3GPP (PSS4)...', None, EXPORT_3GPP),
                        (FLAG_ALL, ENTRY, 'P&rune and publish for Mobile configuration...', None, EXPORT_PRUNE),
...
#               (FLAG_ALL, TOGGLE, 'Show A&ll Properties', None, SHOWALLPROPERTIES),
        ...
        ('&Window', (
                ...
                (FLAG_BOSTON, ENTRY, 'Param&groups', None, PARAMGROUPVIEW),
