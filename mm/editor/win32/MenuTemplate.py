...
MENUBAR=(
	...
	('&View', (
		(TOGGLE, '&Player\tAlt+1', '1', PLAYERVIEW),
		(TOGGLE, '&Layout view\tAlt+2', '2', LAYOUTVIEW),
		(TOGGLE, '&Structure view\tAlt+3', '3', HIERARCHYVIEW),
		(TOGGLE, '&Timeline view\tAlt+4', '4', CHANNELVIEW),
		(TOGGLE, '&Hyperlinks\tAlt+5', '5', LINKVIEW),
		(TOGGLE, 'User &groups\tAlt+6', '6', USERGROUPVIEW),
		(TOGGLE, 'Source\tAlt+7', '7', SOURCE),
		)),
