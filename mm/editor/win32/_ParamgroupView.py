...
# @win32doc|ParamgroupView
# This module contains the ui implementation of the ParamgroupView.
...
# The _ParamgroupView extends the GenFormView which is an extension to PyCFormView.

# The _ParamgroupView is created using the resource dialog template with identifier IDD_USERGROUP.
...
class _ParamgroupView(GenFormView):
