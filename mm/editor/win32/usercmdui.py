...
PASTE_DOCUMENT_UI=CommandUI(PASTE_DOCUMENT)
PASTE_FILE_UI=CommandUI(PASTE_FILE)
...
EXPORT_SMIL_UI=CommandUI(EXPORT_SMIL)
UPLOAD_SMIL_UI=CommandUI(UPLOAD_SMIL)
PROPERTIES_UI=CommandUI(PROPERTIES)
EDITSOURCE_UI=CommandUI(EDITSOURCE)
#
# TopLevel commands
#
...
#
HIDE_PLAYERVIEW_UI=CommandUI(HIDE_PLAYERVIEW)
HIDE_HIERARCHYVIEW_UI=CommandUI(HIDE_HIERARCHYVIEW)
HIDE_CHANNELVIEW_UI=CommandUI(HIDE_CHANNELVIEW)
HIDE_LINKVIEW_UI=CommandUI(HIDE_LINKVIEW)
HIDE_LAYOUTVIEW_UI=CommandUI(HIDE_LAYOUTVIEW)
HIDE_USERGROUPVIEW_UI=CommandUI(HIDE_USERGROUPVIEW)
HIDE_SOURCE_UI=CommandUI(HIDE_SOURCE)
...
EXPAND_UI=CommandUI(EXPAND)
EXPANDALL_UI=CommandUI(EXPANDALL)
COLLAPSEALL_UI=CommandUI(COLLAPSEALL)
TOPARENT_UI=CommandUI(TOPARENT,IDUC_TOPARENT)
TOCHILD_UI=CommandUI(TOCHILD,IDUC_TOCHILD)
NEXTSIBLING_UI=CommandUI(NEXTSIBLING,IDUC_NEXTSIBLING)
PREVSIBLING_UI=CommandUI(PREVSIBLING,IDUC_PREVSIBLING)
...
INFO_UI=CommandUI(INFO,IDUC_INFO)
ATTRIBUTES_UI=CommandUI(ATTRIBUTES,IDUC_ATTRIBUTES)
...
PLAYABLE_UI=CommandUI(PLAYABLE)
TIMESCALE_UI=CommandUI(TIMESCALE)
...
BANDWIDTH_14K4_UI=CommandUI(BANDWIDTH_14K4)
BANDWIDTH_28K8_UI=CommandUI(BANDWIDTH_28K8)
BANDWIDTH_ISDN_UI=CommandUI(BANDWIDTH_ISDN)
BANDWIDTH_T1_UI=CommandUI(BANDWIDTH_T1)
BANDWIDTH_LAN_UI=CommandUI(BANDWIDTH_LAN)
BANDWIDTH_OTHER_UI=CommandUI(BANDWIDTH_OTHER)
