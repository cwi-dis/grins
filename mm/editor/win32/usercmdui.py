...
NEW_BEFORE_IMAGE_UI=CommandUI(NEW_BEFORE_IMAGE)
NEW_BEFORE_TEXT_UI=CommandUI(NEW_BEFORE_TEXT)
NEW_BEFORE_SOUND_UI=CommandUI(NEW_BEFORE_SOUND)
NEW_BEFORE_VIDEO_UI=CommandUI(NEW_BEFORE_VIDEO)
NEW_BEFORE_SLIDESHOW_UI=CommandUI(NEW_BEFORE_SLIDESHOW)
NEW_AFTER_UI=CommandUI(NEW_AFTER)
NEW_AFTER_IMAGE_UI=CommandUI(NEW_AFTER_IMAGE)
NEW_AFTER_TEXT_UI=CommandUI(NEW_AFTER_TEXT)
NEW_AFTER_SOUND_UI=CommandUI(NEW_AFTER_SOUND)
NEW_AFTER_VIDEO_UI=CommandUI(NEW_AFTER_VIDEO)
NEW_AFTER_SLIDESHOW_UI=CommandUI(NEW_AFTER_SLIDESHOW)
NEW_UNDER_UI=CommandUI(NEW_UNDER)
NEW_UNDER_IMAGE_UI=CommandUI(NEW_UNDER_IMAGE)
NEW_UNDER_TEXT_UI=CommandUI(NEW_UNDER_TEXT)
NEW_UNDER_SOUND_UI=CommandUI(NEW_UNDER_SOUND)
NEW_UNDER_VIDEO_UI=CommandUI(NEW_UNDER_VIDEO)
NEW_UNDER_SLIDESHOW_UI=CommandUI(NEW_UNDER_SLIDESHOW)
