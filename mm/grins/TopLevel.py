...
##		t0 = time.time()
		...
		if mtype not in ('application/x-grins-project', 'application/smil', 'application/x-grins-binary-project') (not hasattr(windowinterface, 'is_embedded') or not windowinterface.is_embedded()):
