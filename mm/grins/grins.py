        ...
        if hasattr(features, 'expiry_date') and features.expiry_date:
            ...
            if yymmdd > features.expiry_date:
                rv = windowinterface.GetOKCancel(
                   "This beta copy of Ambulant_G has expired.\n\n"
                   "Do you want to check www.AmbulantPlayer.org for a newer version?")
                if rv == 0:
                    url = 'http://www.AmbulantPlayer.org/indir/%s/update.html'%version.shortversion
...
##             CHOOSECOMPONENTS(callback = (self.components_callback, ())),
        ...
        MainDialog.__init__(self, 'Ambulant')
    ...
    def skin_callback(self):
        ...
        windowinterface.FileDialog('Open Components File', '.', ['text/x-ambulant-skin'], '',
    ...
    def checkversion_callback(self):
        ...
        import windowinterface
        import settings
        url = 'http://www.AmbulantPlayer.org/indir/%s/updatecheck.txt'%version.shortversion
        try:
            fp = MMurl.urlopen(url)
            data = fp.read()
            fp.close()
        except:
            windowinterface.showmessage('Unable to check for upgrade. You can try again later, or visit www.AmbulantPlayer.org with your webbrowser.')
...
def main():
    ...
    try:
        ...
        splash.splash(version = 'Ambulant ' + version)
    ...
    try:
        try:
            ...
            if __debug__:
                ...
                print '\t| ambulant-support@AmbulantPlayer.org with a description  |'
                ...
                import traceback
                print
                print 'Ambulant crash, please e-mail this output to ambulant-support@AmbulantPlayer.org:'
                traceback.print_exception(exc_type, exc_value, exc_traceback)
    finally:
        import windowinterface
