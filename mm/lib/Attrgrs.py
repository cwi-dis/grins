...
##               '.type',
    ...
    {'name':'preferencesPro',
     'title': 'GRiNS preferences',
     'attrs':['default_sync_behavior_locked',
...
##               'comment',
    ...
    {'name':'qtmediapreferences',
     ...
     'attrs':['immediateinstantiationmedia',
              'bitratenecessary',
    ...
    {'name':'containerlayout',
     ...
     'attrs':['project_default_region_image',
