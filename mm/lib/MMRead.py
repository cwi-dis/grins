...
# TODO: instead of creating MMNodes, please create an EditableObject. -mjvdg.
...
def _newctx():
	# by mjvdg: return MMNode.MMNodeContext(MMNode.MMNode)
	import EditableObjects
	return MMNode.MMNodeContext(EditableObjects.EditableMMNode)
