...
class _Toplevel:
	...
	def newwindow(self, x, y, w, h, title, visible_channel, type_channel, pixmap = 0):
		return _Window(self, x, y, w, h, title, visible_channel, type_channel, 0, pixmap, 0)

	def newcmwindow(self, x, y, w, h, title, visible_channel, type_channel, pixmap = 0):
...
class _Window:
	...
	def newwindow(self, type_channel, coordinates, pixmap = 0, transparent = 0):
		win = _SubWindow(self, type_channel, coordinates, 0, pixmap, transparent)
		win._window_state = HIDDEN
		return win

	def newcmwindow(self, type_channel, coordinates, pixmap = 0, transparent = 0):
