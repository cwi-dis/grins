...
##		del self.ted
	...
	def setcolors(self, bg, fg, an, recalc=0):
		pass	# Ignored for the time being. Only bgcolor is needed for SMIL.
##		any = 0
##		if not bg is None:
##			self.bg_color = bg
##			any = 1
...
##			self.new_font(self.html_font)
	...
	def setfonts(self, normal, tt, defsize, recalc=0):
		pass	# Ignored for the time being, unsupported in SMIL.
##		any = 0
##		if normal != None:
...
##		return 1
	...
	def do_activate(self):
		self.widget.HRActivate()

	def do_deactivate(self):
		self.widget.HRDeactivate()
...
##		self._updatescrollbars()
		self.widget.HRDraw(myregion)
		# XXXX How about DisposeRgn?
