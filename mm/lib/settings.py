...
MODULES = {
    # SMIL 3.0 Modules (also includes most of the SMIL 2.1 modules)
    'BasicText': 0,
    'DOMTimingMethods': 0,
    'Identity': 0,
    'MediaOpacity': 0,
    'MediaPanZoom': 0,
    'MediaRenderAttributes': 0,
    'RequiredContentControl': 0,
    ...
    # SMIL 2.1 Modules (also includes most of the SMIL 2.0 modules)
    'AlignmentLayout': 0,
    'BackgroundTilingLayout': 0,
    'BasicExclTimeContainers': 0,
    'BasicPriorityClassContainers': 0,
    'FullScreenTransitionEffects': 0,
    'OverrideLayout': 0,
    'SubRegionLayout': 0,
    ...
    'EventTiming': 0,
    'ExclTimeContainers': 0,            # not in SMIL 2.1
    'FillDefault': 0,
    'HierarchicalLayout': 0,            # not in SMIL 2.1
    'InlineTransitions': 0,
    'LinkingAttributes': 0,
...
SMIL_21_MOBILE_MODULES = SMIL_PSS5_MODULES + [
    'AccessKeyTiming',
    'AlignmentLayout',
    'AudioLayout',
...
# This profile is a strict extension of the SMIL 2.1 Mobile Profile.
SMIL_21_EXTENDED_MOBILE_MODULES = SMIL_21_MOBILE_MODULES + [
    'BasicAnimation',
...
# Mostly the same as SMIL 2.0 Language Profile, except that
# ExclTimeContainers and HierarchicalLayout have been replaced by
# AlignmentLayout, BasicExclTimeContainers,
# BasicPriorityClassContainers, OverrideLayout, and SubRegionLayout,
# and there are two new modules: BackgroundTilingLayout and
# FullScreenTransitionEffects.
# This profile is a strict extension of the SMIL 2.1 Extended Mobile
# Profile.
SMIL_21_MODULES = SMIL_21_EXTENDED_MOBILE_MODULES + [
...
SMIL_30_TINY_MODULES = [
    ...
    # SMIL 3.0 Pseudo Modules
    'NestedTimeContainers',
    ]

# SMIL 3.0 Mobile Profile
# This profile is a strict extension of the SMIL 3.0 Tiny Profile
SMIL_30_MOBILE_MODULES = SMIL_30_TINY_MODULES + [
    'MediaClipping',
    'MediaParam',
...
# This profile is a strict extension of the SMIL 3.0 Mobile Profile
SMIL_30_EXTENDED_MOBILE_MODULES = SMIL_30_MOBILE_MODULES + [
    'BrushMedia',
    'BasicExclTimeContainers',
    'MultiArcTiming',
    'MultiWindowLayout',
...
# This profile is a strict extension of the SMIL 3.0 Tiny Profile
SMIL_30_DAISY_MODULES = SMIL_30_TINY_MODULES + [
    'MediaClipping',
    'MediaParam',
    'BasicExclTimeContainers',
    'EventTiming',
...
# This profile is a strict extension of the SMIL 3.0 Extended Mobile Profile
SMIL_30_LANGUAGE_MODULES = SMIL_30_EXTENDED_MOBILE_MODULES + [
    'MediaClipMarkers',
    'MediaOpacity',
    'MediaPanZoom',
    'BasicPriorityClassContainers',
...
def switch_profile(modulelist):
    ...
    from SMIL import SMIL10, SMIL20ns, PSS4ns, PSS5ns
    if __debug__:
        ...
        elif modulelist == SMIL_21_MOBILE_MODULES:
            name = 'SMIL 2.1 Mobile Profile'
        elif modulelist == SMIL_21_EXTENDED_MOBILE_MODULES:
            name = 'SMIL 2.1 Extended Mobile Profile'
        elif modulelist == SMIL_21_MODULES:
            name = 'SMIL 2.1 Language Profile'
        elif modulelist == SMIL_30_TINY_MODULES:
            name = 'SMIL 3.0 Tiny Profile'
        elif modulelist == SMIL_30_MOBILE_MODULES:
            name = 'SMIL 3.0 Mobile Profile'
        elif modulelist == SMIL_30_EXTENDED_MOBILE_MODULES:
            name = 'SMIL 3.0 Extended Mobile Profile'
        elif modulelist == SMIL_30_DAISY_MODULES:
            name = 'SMIL 3.0 Daisy Profile'
        elif modulelist == SMIL_30_LANGUAGE_MODULES:
            name = 'SMIL 3.0 Language Profile'
        else:
...
##     'compatibility': G2,        # Try to be compatible with...
    ...
    'fgcolor': (0, 0, 0),               # ultimate default foreground
    'bgcolor': (255, 255, 255),         # ultimate default background
...
ALL=['system_bitrate', 'system_captions', 'system_language',
     ...
     'system_version', 'system_base_profile']
...
def get(name):
    ...
    if real_value is None:
        ...
        if name == 'system_cpu':
            import opsys
            for k, v in opsys.cpu.items():
                if v:
                    return k
            return 'UNKNOWN'
        if name == 'system_operating_system':
            import opsys
            for k, v in opsys.opsys.items():
                if v:
                    return k
            return 'UNKNOWN'
