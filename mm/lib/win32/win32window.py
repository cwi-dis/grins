...
class Window:
    ...
    def bgimage(self, bgimage, bgrepeat):
        self._bgimage = bgimage
        self._bgrepeat = bgrepeat
    ...
    def newwindow(self, coordinates, pixmap = 0, transparent = 0, z = 0, units = None, bgcolor = None):
        return Window(self, coordinates, units, z, transparent, bgcolor)
