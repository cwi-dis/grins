...
##		del self.tmplicensedialog
		...
		if ENABLE_FNORB_SUPPORT:
			import grinsDOM.CORBA.services
			self.corba_services = grinsDOM.CORBA.services.services(sys.argv,self)
...
def main():
	...
	try:
		...
		if ENABLE_FNORB_SUPPORT:
			splash.splash(version = 'GRiNS/CORBA server ' + version)
		else:
