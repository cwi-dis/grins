...
\section{\module{audio} functions and variables}
...
\module{audio.convert} module for details.
\end{funcdesc}
...
\section{\module{audio.file} functions}
...
\section{\module{audio.convert} functions}
...
\section{\module{audio.format} variables and methods}
...
\section{\module{audio.merge} functions}
...
\code{audio.file.reader()}, and by \code{audio.convert.convert()}.
...
\section{\module{audio.dev} functions}
