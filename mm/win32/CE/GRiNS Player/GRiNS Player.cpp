// GRiNS Player.cpp : Defines the entry point for the application.
//
...
ATOM MyRegisterClass(HINSTANCE hInstance, LPTSTR szWindowClass)
{
    ...
    wc.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_GRINSPLAYER));
    wc.hCursor			= 0;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow, HWND *phWnd)
{
	...
	LoadString(hInstance, IDC_GRINSPLAYER, szWindowClass, MAX_LOADSTRING);
