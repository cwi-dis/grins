...
public class DemoApplet extends Applet
{
	...
	public void init()
	{
		...
		setSize(480,413);
		add(playerCanvas);
		playerCanvas.setBackground(java.awt.Color.pink);
		playerCanvas.setBounds(28,25,297,300);
    ...
    public static void main(String args[]) 
		...
		SFrame f = new SFrame("GRiNS Player sample");
		f.addWindowListener(
			new WindowAdapter() { 
        ...
        f.setApplet(demoApplet);
		demoApplet.init();
		demoApplet.start();
		f.add("Center", demoApplet);
		f.setSize(500,420);
		f.show();
		}
