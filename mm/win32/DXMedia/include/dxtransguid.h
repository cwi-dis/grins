...
const IID IID_IDXBufferCache = {0xE287685A,0xB93C,0x11d1,{0x90,0x5A,0x00,0xC0,0x4F,0xD9,0x18,0x9D}};


const IID IID_IDXBuffer = {0x01BAFC7D,0x9E63,0x11d1,{0x90,0x53,0x00,0xC0,0x4F,0xD9,0x18,0x9D}};


const IID IID_IDXFileBuffer = {0x99074961,0xF917,0x11d0,{0x88,0x3A,0x3C,0x8B,0x00,0xC1,0x00,0x00}};


const IID IID_IDXMemoryBuffer = {0x9CED2EC1,0xF91A,0x11d0,{0x88,0x3A,0x3C,0x8B,0x00,0xC1,0x00,0x00}};
...
const CLSID CLSID_DXTransformFactory = {0xD1FE6762,0xFC48,0x11D0,{0x88,0x3A,0x3C,0x8B,0x00,0xC1,0x00,0x00}};


const CLSID CLSID_DXTaskManager = {0x4CB26C03,0xFF93,0x11d0,{0x81,0x7E,0x00,0x00,0xF8,0x75,0x57,0xDB}};


const CLSID CLSID_DXTScale = {0x555278E2,0x05DB,0x11D1,{0x88,0x3A,0x3C,0x8B,0x00,0xC1,0x00,0x00}};


const CLSID CLSID_DXTLabel = {0x54702535,0x2606,0x11D1,{0x99,0x9C,0x00,0x00,0xF8,0x75,0x6A,0x10}};


const CLSID CLSID_DX2D = {0x473AA80B,0x4577,0x11D1,{0x81,0xA8,0x00,0x00,0xF8,0x75,0x57,0xDB}};


const CLSID CLSID_DXSurface = {0x0E890F83,0x5F79,0x11D1,{0x90,0x43,0x00,0xC0,0x4F,0xD9,0x18,0x9D}};


const CLSID CLSID_DXSurfaceModifier = {0x3E669F1D,0x9C23,0x11d1,{0x90,0x53,0x00,0xC0,0x4F,0xD9,0x18,0x9D}};


const CLSID CLSID_DXRasterizer = {0x8652CE55,0x9E80,0x11D1,{0x90,0x53,0x00,0xC0,0x4F,0xD9,0x18,0x9D}};


const CLSID CLSID_DXGradient = {0xC6365470,0xF667,0x11d1,{0x90,0x67,0x00,0xC0,0x4F,0xD9,0x18,0x9D}};
