...
// vid2wm.ax - A filter for converting video to windows media using wmf sdk
...
{
    &CLSID_Vid2wm,				// Filter CLSID
    L"Video Windows Media Converter",// Filter name
...
CFactoryTemplate g_Templates[] = {
    { L"Video Windows Media Converter"
    , &CLSID_Vid2wm
...
{
    return  new CVideoRenderer(NAME("Video Windows Media Converter"),pUnk,phr);
} 
