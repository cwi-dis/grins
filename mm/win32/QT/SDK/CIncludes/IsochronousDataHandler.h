...
typedef TVECTOR_UPP_TYPE(IDHNotificationProc)                   IDHNotificationProcUPP;
...
#if OPAQUE_UPP_TYPES
    EXTERN_API(IDHNotificationProcUPP)
    NewIDHNotificationProcUPP      (IDHNotificationProc     userRoutine);

    EXTERN_API(void)
    DisposeIDHNotificationProcUPP    (IDHNotificationProcUPP userUPP);

    EXTERN_API(OSStatus)
    InvokeIDHNotificationProcUPP    (IDHGenericEvent *      event,
                                    void *                  userData,
                                    IDHNotificationProcUPP  userUPP);

#else
    #define NewIDHNotificationProcUPP(userRoutine)                  (userRoutine)
    #define DisposeIDHNotificationProcUPP(userUPP)                  
    #define InvokeIDHNotificationProcUPP(event, userData, userUPP)  (*userUPP)(event, userData)
#endif
