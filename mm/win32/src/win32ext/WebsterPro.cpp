...
long CWebsterPro::GetPrintPageBreakForImages()
{
	long result;
...
void CWebsterPro::SetPrintPageBreakForImages(long propVal)
{
	SetProperty(0x85, VT_I4, propVal);
}

long CWebsterPro::GetPrintPageBreakForTables()
{
	long result;
...
void CWebsterPro::SetPrintPageBreakForTables(long propVal)
{
	SetProperty(0x86, VT_I4, propVal);
}

long CWebsterPro::GetTextCopyMode()
{
	long result;
...
void CWebsterPro::SetTextCopyMode(long propVal)
{
	SetProperty(0x87, VT_I4, propVal);
}

unsigned long CWebsterPro::GetVisitedColor()
{
	unsigned long result;
...
void CWebsterPro::SetVisitedColor(unsigned long propVal)
{
	SetProperty(0x88, VT_I4, propVal);
}

long CWebsterPro::GetStatusDisplay()
{
	long result;
...
void CWebsterPro::SetStatusDisplay(long propVal)
{
	SetProperty(0x89, VT_I4, propVal);
}

unsigned long CWebsterPro::GetActiveColor()
{
	unsigned long result;
...
void CWebsterPro::SetActiveColor(unsigned long propVal)
{
	SetProperty(0x8a, VT_I4, propVal);
}

unsigned long CWebsterPro::GetHoverColor()
{
	unsigned long result;
...
void CWebsterPro::SetHoverColor(unsigned long propVal)
{
