...
extern int mpeg2_ac3_samplerates[3];

// Exponent strategy constants
#define MPEG2_EXP_REUSE (0)
#define MPEG2_EXP_D15   (1)
#define MPEG2_EXP_D25   (2)
#define MPEG2_EXP_D45   (3)
...
typedef float mpeg2ac3_stream_samples_t[6][256];

struct mpeg2_ac3bsi_t
	{
...
// Bit allocation data
struct mpeg2_ac3_bitallocation_t
	{
	int sdecay;
	int fdecay;
	int sgain;
...
int mpeg2audio_ac3_exponent_unpack(mpeg2audio_t *audio,
		mpeg2_ac3bsi_t *bsi,
