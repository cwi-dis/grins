...
// get reference frame
void mpeg_video::spatial_prediction()
{
  ...
  else
  {
	...
	// Y
	make_spatial_prediction_frame(progressive_frame,lower_layer_progressive_frame,llframe0[0],llframe1[0],
	...
	// Cb
  make_spatial_prediction_frame(progressive_frame,lower_layer_progressive_frame,llframe0[1],llframe1[1],
  ...
  // Cr
  make_spatial_prediction_frame(progressive_frame,lower_layer_progressive_frame,llframe0[2],llframe1[2],
...
void mpeg_video::read_lower_layer_component_framewise(int comp,int lw,int lh)
{
  FILE *fd;
  char fname[256];
  char ext[3][3] = {".Y",".U",".V"}; 
...
void mpeg_video::read_lower_layer_component_fieldwise(int comp,int lw,int lh)
{
  FILE *fd;
  char fname[256];
  char ext[3][3] = {".Y",".U",".V"}; 
...
void mpeg_video::make_spatial_prediction_frame (int progressive_frame,
...
void mpeg_video::deinterlace (unsigned char *fld0, unsigned char *fld1,
...
/* vertical resampling */
void mpeg_video::subsample_vertical (unsigned char *s, short *d,
...
void mpeg_video::subsample_horizontal (short *s, unsigned char *d,
